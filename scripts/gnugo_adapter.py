...
class GNUGoBot:
    def __init__(self, gnugo_path: str, board_size: int = 19, komi: float = 6.5, rules: str = "chinese"):
    ...
    def start(self) -> bool:
        ...
        try:
            ...
            if self.rules == "japanese":
                self._send_command("set_rules japanese")
            else:
                self._send_command("set_rules chinese")
