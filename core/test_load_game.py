...
def continue_game_from_sgf():
    ...
    # Поиск доступных SGF файлов
    saves_dir = cfg.get_saves_dir()
    sgf_files = []
    
    # Ищем SGF файлы в директориях pvp, pve, loaded
    ...
    try:
        ...
        # Получаем результат, если партия завершена
...
def play_continued_game(game, size, black_name, white_name, original_sgf_path):
    ...
    while game_active:
        ...
        # Вывод возможных ходов (опционально)
        legal_moves = game.get_legal_moves()
        print_legal_moves_board(legal_moves, size)
